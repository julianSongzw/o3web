...
//色域
export const FACTOR_COLOR_LIST_QUERY = 'FACTOR_COLOR_LIST_QUERY';
export const factorColorListQuery= createAction(FACTOR_COLOR_LIST_QUERY);

//色域
export const FACTOR_COLOR_LIST_QUERY_SUCCESS = 'FACTOR_COLOR_LIST_QUERY_SUCCESS';
export const factorColorListQuerySuccess= createAction(FACTOR_COLOR_LIST_QUERY_SUCCESS);

//色域
export const FACTOR_COLOR_LIST_QUERY_FAIL = 'FACTOR_COLOR_LIST_QUERY_FAIL';
export const factorColorListQueryFail= createAction(FACTOR_COLOR_LIST_QUERY_FAIL);
