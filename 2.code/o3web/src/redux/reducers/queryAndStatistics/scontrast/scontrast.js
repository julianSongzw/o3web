 ...
 */
import * as act from '../../../actions/queryAndStatistics/scontrast/scontrast';
...
export default function Scontrast(state = initState, action) {
    switch (action.type) {
        case act.SCONTRAST_QUERY_SUCCESS:
            return  {
                ...state,
                singleQueryRet: 0,
                singleQueryInfo:action.payload
            };
        case act.SCONTRAST_QUERY_FAIL:
            return  {
                ...state,
