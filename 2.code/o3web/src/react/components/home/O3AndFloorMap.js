...
class O3AndFloorMap extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            modelShow: false,
            factor: this.props.selectWebDeviceInfo.factor,
            h_start: config.heightStep,
            h_end: config.maxHeight,
            h_index: config.heightStep,
            scode: this.props.selectWebDeviceInfo.site,
            time_cj: '',
            time: '',
        }
    }
    ...
    render() {
        return (
            <div>
                <div id="O3AndFloorMapData" style={{ height: "500px", width: "90%", marginLeft: "5%" }}>数据获取中...</div>
                <Modal
